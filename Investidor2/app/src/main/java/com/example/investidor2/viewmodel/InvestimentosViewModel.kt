...
class InvestimentosViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun monitorarAlteracoes() {
        ...
        database.addChildEventListener(object : ChildEventListener {
            override fun onChildChanged(
                ...
                Log.i("Firebase", "Nome: $nome, Valor: $valor")

                // chamar método enviaNotificacao()
                enviarNotificacao(
                ...
                // chamar método carregarInvestimentos
            ...
            override fun onCancelled(error: DatabaseError) {
                Log.e(
                    "FirebaseError",
                    "Erro ao monitorar alteracoes: ${error.message}",
                    error.toException()
                )
            }
    ...
    private fun enviarNotificacao(titulo: String, mensagem: String, context: Context) {
        ...
        if (ActivityCompat.checkSelfPermission(
            ...
            Log.e("Notificacao", "Permissao negada")
            return
        }
